...
class window_size extends StatefulWidget {
  final type,ssize;

  const window_size({ Key? key, this.type,this.ssize }): super(key: key);

  @override
  _window_sizeState createState() => _window_sizeState();
}

class _window_sizeState extends State<window_size> {
