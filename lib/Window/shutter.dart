...
class shutter extends StatefulWidget {
  final type;
  const shutter({Key? key,required this.type}) : super(key: key);

  @override
  _shutterState createState() => _shutterState();
}

class _shutterState extends State<shutter> {
  static const l = ["3 \" x 1 1/2\""];
  int door = -1;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => shutter_size(type: 'Shutters',ssize : s),
                            ));
                        // switch(door){
                        //   case 0:
