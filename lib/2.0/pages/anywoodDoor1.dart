...
import 'anywoodDoor2.dart';
import 'myNilai2.dart';
class anyWoodDoor1 extends StatefulWidget {
  final users;
  const anyWoodDoor1({Key? key, required this.users}) : super(key: key);

  @override
  _anyWoodDoor1State createState() => _anyWoodDoor1State();
}

class _anyWoodDoor1State extends State<anyWoodDoor1> {
  String woodType = "";
  int number = 0;
                        ...
                        child: Container(
                          child:ElevatedButton(
                              ...
                              onPressed: () async{
                                ...
                                widget.users["anyWoodDoor Wood Name"] = woodType;
                                widget.users["anyWoodDoor No. of pieces"] = number;
                                widget.users["anyWoodDoors"] = List<Map<String, String>>.filled(number, Map(), growable: false);

                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => anyWoodDoor2(users:widget.users, index:0))
                                );
                                print(widget.users);
