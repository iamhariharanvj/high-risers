...
class shutter3 extends StatefulWidget {
  final users;

  const shutter3({ Key? key, this.users }): super(key: key);

  @override
  _shutter3State createState() => _shutter3State();
}

class _shutter3State extends State<shutter3> {
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        widget.users["shutter size"] = s;
                        await Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => shutter4(users:widget.users)));
                        // switch(door){
                        //   case 0:
