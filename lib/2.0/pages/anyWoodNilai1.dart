...
class anyWoodNilai1 extends StatefulWidget {
  final users;
  const anyWoodNilai1({Key? key, required this.users}) : super(key: key);

  @override
  _anyWoodNilai1State createState() => _anyWoodNilai1State();
}

class _anyWoodNilai1State extends State<anyWoodNilai1> {
  String woodType = "";
  int number = 0;
                        ...
                        child: Container(
                          child:ElevatedButton(
                              ...
                              onPressed: () async{
                                ...
                                widget.users["anyWoodNilai Wood Name"] = woodType;
                                widget.users["anyWoodNilai No. of pieces"] = number;
                                widget.users["anyWoodNilais"] = List<Map<String, String>>.filled(number, Map(), growable: false);
                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => anyWoodNilai2(users:widget.users, index: 0))
                                );
                                print(widget.users);
