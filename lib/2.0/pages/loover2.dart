...
class loover2 extends StatefulWidget {
  final users;
  final index;
  const loover2({Key? key,required this.users, this.index}) : super(key: key);

  @override
  _loover2State createState() => _loover2State();
}

class _loover2State extends State<loover2> {
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        map['loover Log Size'] = s.toString();
                        widget.users["loovers"][widget.index] = map;

                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => loover3(users: widget.users, index:widget.index),
                            ));
                      },
