...
class windowOrder extends StatefulWidget {
  final users;
  final index;
  const windowOrder({Key? key,required this.users, this.index}) : super(key: key);



  @override
  _windowOrderState createState() => _windowOrderState();
}

class _windowOrderState extends State<windowOrder> {
  File? _image;
  ...
  storeImage(image) async
  {
    ...
    try {
      ...
      var snapshot = _storage.ref()
          .child("orders/$folder/" + "Window Order")
          .putFile(file);
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        map["window Orderimage"] = _image!.path;
                        widget.users["windows"][widget.index] = map;
                        storeImage(_image);
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => windowView(
