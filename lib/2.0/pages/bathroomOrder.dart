...
class bathroomOrder extends StatefulWidget {
  final users;
  final index;
  const bathroomOrder ({Key? key,required this.users, this.index}) : super(key: key);



  @override
  _bathroomOrderState createState() => _bathroomOrderState();
}

class _bathroomOrderState extends State<bathroomOrder > {
  File? _image;
  ...
  storeImage(image) async
  {
    ...
    try {
      ...
      var snapshot = _storage.ref()
          .child("orders/$folder/" + "BedroomDoor Order")
          .putFile(file);
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        map["bedroomdoor Orderimage"] = _image!.path;
                        widget.users["bedroomdoors"][widget.index] = map;
                        storeImage(_image);
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => bathroomView(
