...
class shutterOrder extends StatefulWidget {
  final users;
  final index;
  const shutterOrder({Key? key,required this.users, this.index}) : super(key: key);

  @override
  _shutterOrderState createState() => _shutterOrderState();
}

class _shutterOrderState extends State<shutterOrder> {
  File? _image;
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        map["shutter Orderimage"] = _image!.path;
                        widget.users["shutters"][widget.index] = map;
                        storeImage(_image);
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => shutterView(
