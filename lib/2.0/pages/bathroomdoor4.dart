...
import 'bathroomdoor5.dart';
import 'door3.dart';

class bathroomdoor4 extends StatefulWidget {
  final users;
  final index;

  const bathroomdoor4({ Key? key, this.users, this.index }): super(key: key);

  @override
  _bathroomdoor4State createState() => _bathroomdoor4State();
}

class _bathroomdoor4State extends State<bathroomdoor4 > {
  String s1 = "";
  String s2 = "";
  static const t = {
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async{
                      ...
                      map['bedroomdoor Size'] = s.toString();
                      widget.users["bedroomdoors"][widget.index] = map;

                      await Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => bathroomdoor5(users:widget.users, index:widget.index)));
