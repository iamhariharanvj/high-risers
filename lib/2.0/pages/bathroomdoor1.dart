...
class bathroomdoor1 extends StatefulWidget {
  final users;
  const bathroomdoor1({Key? key, required this.users}) : super(key: key);

  @override
  _bathroomdoor1State createState() => _bathroomdoor1State();
}

class _bathroomdoor1State extends State<bathroomdoor1> {
  String woodType = "";
  int number = 0;
                        ...
                        child: Container(
                          child:ElevatedButton(
                              ...
                              onPressed: () async{
                                ...
                                widget.users["bedroomdoor Wood Name"] = woodType.toString();
                                widget.users["bedroomdoor No. of pieces"] = number;
                                widget.users["bedroomdoors"] = List<Map<String, String>>.filled(number, Map(), growable: false);

                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => bathroomdoor3(users:widget.users, index:0))
                                );
                                print(widget.users);
