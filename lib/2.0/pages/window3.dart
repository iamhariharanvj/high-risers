...
import 'package:highrisers/2.0/pages/window4.dart';
...
class window3 extends StatefulWidget {
  final users;
  final index;
  const window3({Key? key,required this.users, this.index}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        map["window Log Size"] = s.toString();
                        widget.users["windows"][widget.index] = map;

                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => window4(users: widget.users, index: widget.index),
                            ));
                        // switch(door){
                        //   case 0:
