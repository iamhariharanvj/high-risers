...
class myNilai2 extends StatefulWidget {
  final users;
  final index;

  const myNilai2({ Key? key, this.index, this.users}): super(key: key);

  @override
  _myNilai2State createState() => _myNilai2State();
}

class _myNilai2State extends State<myNilai2> {
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async{
                          ...
                          map['mainNilai Size'] = st.toString();
                          widget.users["mainNilais"][widget.index] = map;
                          print(widget.users);
                         Navigator.of(context).push(
                             MaterialPageRoute(builder: (context) => myNilai3(users: widget.users, index: widget.index)));
                         }
                      ),
                    ),
                  ),
