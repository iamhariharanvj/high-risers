...
class poojadoor1 extends StatefulWidget {
  final users;
  const poojadoor1({Key? key, required this.users}) : super(key: key);

  @override
  _poojadoor1State createState() => _poojadoor1State();
}

class _poojadoor1State extends State<poojadoor1> {
  String woodType = "";
  int  number = 0;
                        ...
                        child: Container(
                          child:ElevatedButton(
                              ...
                              onPressed: () async{
                                ...
                                widget.users["poojadoor Wood type"] = woodType.toString();
                                widget.users["poojadoor pieces"] = number;
                                widget.users["poojadoors"] = List<Map<String, String>>.filled(number, Map(), growable: false);

                                if(number != "")
                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => poojadoor2(users:widget.users, index:0))
                                );
                                print(widget.users);
