...
class Window0 extends StatelessWidget {
  final users;
  const Window0({Key? key, required this.users}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: Container(
                      child:ElevatedButton(
                          ...
                          onPressed: () async{
                            users["window Title"] = "Windows";
                            Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => window1(users:users))
                            );
                  ...
                  child: Container(
                    ...
                    child: Container(
                      child:ElevatedButton(
                          ...
                          onPressed: () async{
                            users["window Title"] = "Windows";
                            users["window Wood Name"] = "NA";
                            users["window No. of pieces"] = "NA";
                            users["windows"] = [];
                            print(users);
                            Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => shutter(users:users))
                            );
