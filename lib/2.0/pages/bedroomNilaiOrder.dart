...
import 'bedroomNilaiView.dart';
import 'myNilaiView.dart';


class bedroomNilaiOrder extends StatefulWidget {
  final users;
  final index;
  const bedroomNilaiOrder({Key? key,required this.users, required this.index}) : super(key: key);



  @override
  _bedroomNilaiOrderState createState() => _bedroomNilaiOrderState();
}

class _bedroomNilaiOrderState extends State<bedroomNilaiOrder> {
  File? _image;
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        map["bedroomNilai Orderimage"] = _image!.path;
                        widget.users["bedroomNilais"][widget.index] = map;
                        storeImage(_image);
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => bedroomNilaiView(
