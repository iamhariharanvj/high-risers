...
class shutter4 extends StatefulWidget {
  final users;
  const shutter4({Key? key, required this.users}) : super(key: key);

  @override
  _shutter4State createState() => _shutter4State();
}

class _shutter4State extends State<shutter4> {
  String carving = "";
                      ...
                      child: Container(
                        child:ElevatedButton(
                            ...
                            onPressed: () async{
                              ...
                              widget.users["shutter hole"] = carving;
                              Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context) => shutter5(users:widget.users))
                              );
                              print(widget.users);
