...
class door1 extends StatefulWidget {
  final users;
  final index;
  const door1({Key? key,this.users, this.index}) : super(key: key);

  @override
  _door1State createState() => _door1State();
}

class _door1State extends State<door1> {
  int door = -1;
  static const d = {
    0 : 'Single',
    1:'Double',
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        map['door Type'] = s.toString();
                        widget.users["doors"][widget.index] = map;

                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => door2(users:widget.users, index:widget.index),
                            ));
                      },
