...
import 'package:highrisers/2.0/pages/shutter4.dart';
import 'package:highrisers/doors/single.dart';

import 'loover4.dart';


class loover3 extends StatefulWidget {
  final users;
  final index;

  const loover3({ Key? key, this.users, this.index}): super(key: key);

  @override
  _loover3State createState() => _loover3State();
}

class _loover3State extends State<loover3> {

  static const w = ["2 \' X 2\'","1 1/2 \' x 2\'","2\' x 3\'"];
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        map['loover Size'] = s.toString();
                        widget.users["loovers"][widget.index] = map;

                        await Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => loover4(users:widget.users, index:widget.index)));
                        // switch(door){
                        //   case 0:
