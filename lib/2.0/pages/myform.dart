...
class _myFormState extends State<myForm> {
  ...
  String cdate2 = DateFormat("MMM, dd, yyyy").format(DateTime.now());
  var dt = DateTime.now();
  ...
  storeImage(image,contact) async
  {
    ...
    try {
      ...
      var snapshot = _storage.ref()
          .child("orders/$folder/" + "Profile Image")
          .putFile(file);
  ...
  {
    _orderId = "";
    _orderId += counter.toString().padLeft(4, '0')+"/"+months[dt.month-1]+"/"+dt.year.toString();
    return _orderId;
  }
  String orderDate()
  {
    _orderDate = "";
    _orderDate += months[dt.month-1]+"-"+dt.day.toString()+"-"+dt.year.toString();
    return _orderDate;
  }
