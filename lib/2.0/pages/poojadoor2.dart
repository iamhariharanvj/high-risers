...
import 'package:highrisers/2.0/pages/poojadoor3.dart';
import 'package:highrisers/dsize/singleSize.dart';

import 'door2.dart';


class poojadoor2 extends StatefulWidget {
  final users;
  final index;
  const poojadoor2({Key? key,this.users, this.index}) : super(key: key);

  @override
  _poojadoor2State createState() => _poojadoor2State();
}

class _poojadoor2State extends State<poojadoor2> {
  int door = -1;
  static const d = {
    0 : 'Single',
    1:'Double',
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        map['poojadoorType'] = s.toString();
                        widget.users["poojadoors"][widget.index] = map;

                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => poojadoor3(users:widget.users, index:widget.index),
                            ));
                        // switch(door){
                        //   case 0:
