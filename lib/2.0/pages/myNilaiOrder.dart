...
class myNilaiOrder extends StatefulWidget {
  final users;
  final index;
  const myNilaiOrder({Key? key,required this.users, required this.index}) : super(key: key);

  @override
  _myNilaiOrderState createState() => _myNilaiOrderState();
}

class _myNilaiOrderState extends State<myNilaiOrder> {
  File? _image;
  ...
  storeImage(image) async
  {
    ...
    try {
      ...
      var snapshot = _storage.ref()
          .child("orders/$folder/" + "MainNilai Order" )
          .putFile(file);
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        map["mainNilai Orderimage"] = _image!.path;
                        widget.users["mainNilais"][widget.index] = map;
                        storeImage(_image);
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => myNilaiView(
