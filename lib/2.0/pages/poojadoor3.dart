...
import 'package:highrisers/2.0/pages/poojadoor4.dart';
import 'package:highrisers/doors/single.dart';

import 'door3.dart';

class poojadoor3 extends StatefulWidget {
  final users;
  final index;
  const poojadoor3({ Key? key, this.users, this.index }): super(key: key);

  @override
  _poojadoor3State createState() => _poojadoor3State();
}

class _poojadoor3State extends State<poojadoor3> {
  String s1 = "";
  String s2 = "";
  static const t = {
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async{
                      ...
                      map['poojadoor size'] = s.toString();
                      widget.users["poojadoors"][widget.index] = map;

                      await Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => poojadoor4(users:widget.users, index:widget.index)));
