...
class anyWoodNilai2 extends StatefulWidget {
  final users;
  final index;
  const anyWoodNilai2({Key? key, required this.users, required this.index}) : super(key: key);

  @override
  _anyWoodNilai2State createState() => _anyWoodNilai2State();
}

class _anyWoodNilai2State extends State<anyWoodNilai2> {
  String woodType = "";
  String s1 = "";
  String s2 = "";
  String t1 = "";
                        ...
                        child: Container(
                          child:ElevatedButton(
                              ...
                              onPressed: () async{
                                ...
                                map["anyWoodNilai Top Size"] = t1;
                                map["anyWoodNilai Side Size"] = s1;
                                map["anyWoodNilai Polish"] = polish;
                                widget.users["anyWoodNilais"][widget.index] = map;
                                Navigator.of(context).push(
                                    MaterialPageRoute(builder: (context) => anyWoodNilai4(users:widget.users, index: widget.index))
                                );
                                print(widget.users);
