...
import 'package:highrisers/2.0/pages/shutter0.dart';
...
class shutter extends StatelessWidget {
  final users;
  const shutter({Key? key, required this.users}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: Container(
                      child:ElevatedButton(
                          ...
                          onPressed: () async{
                            users["shutter Title"] = "Shutter";
                            Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => shutter0(users:users))
                            );
                  ...
                  child: Container(
                    ...
                    child: Container(
                      child:ElevatedButton(
                          ...
                          onPressed: () async{
                            users["shutter Title"] = "Shutter";
                            users["shutter No. of pieces"] = "NA";
                            users["shutters"] = [];

                            print(users);
                            Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => loover(users:users))
                            );
