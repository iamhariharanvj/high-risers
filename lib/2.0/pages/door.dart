...
class door extends StatelessWidget {
  final users;
  const door({Key? key, required this.users}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: Container(
                      child:ElevatedButton(
                          ...
                          onPressed: () async{
                            users["door Title"] = "Doors";
                            Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => door0(users:users))
                            );
                          }
                  ...
                  child: Container(
                    ...
                    child: Container(
                      child:ElevatedButton(
                          ...
                          onPressed: () async{
                            users["door Title"] = "Doors";
                            users["door Wood Name"] = "NA";
                            users["door No. of pieces"] = "NA";
                            users["doors"] = [];
                            print(users);
                            Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => bathroomdoor(users:users))
                            );
