...
import 'loouverSize.dart';

class loouvers extends StatefulWidget {
  final type;
  const loouvers({Key? key,required this.type}) : super(key: key);

  @override
  _loouversState createState() => _loouversState();
}

class _loouversState extends State<loouvers> {
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => loouver_size(type: widget.type,ssize : s),
                            ));
                        // switch(door){
                        //   case 0:
