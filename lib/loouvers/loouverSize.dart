...
class loouver_size extends StatefulWidget {
  final type,ssize;

  const loouver_size({ Key? key, this.type,this.ssize }): super(key: key);

  @override
  _loouver_sizeState createState() => _loouver_sizeState();
}

class _loouver_sizeState extends State<loouver_size> {
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        ...
                        await Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => single(doorSize : (s + "- " + widget.ssize),type:widget.type)));
                        // switch(door){
                        //   case 0:
